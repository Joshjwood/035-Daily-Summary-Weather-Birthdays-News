...
def today_weather(weather_data):
    ...
    return f"Subject:{email_title} in Bournemouth\n\nToday:\n{email_content} and it's {today_day_temp} degrees celsius.\n\n"
